...
{
    ZJCustomHud * custom = [[ZJCustomHud alloc]initWithFrame:CGRectMake(0,0, SCREEN_WIDTH, SCREEN_HEIGHT+100)];
    Hud=custom;
   
    [[UIApplication sharedApplication].keyWindow addSubview:custom];
    UIView * customView = [[UIView alloc]initWithFrame:CGRectMake([UIScreen mainScreen].bounds.size.width/2-75, [UIScreen mainScreen].bounds.size.height/2-60, 150, 120)];
